...
const Footer = () => {
  ...
  return (
    <footer id='footer' className="flex flex-col relative items-center justify-center border border-[#172746] mb-16 rounded-2xl pb-3 px-6 lg:px-8 w-full max-w-6xl mx-auto">
      {/* Background blurs */}
      ...
      <div className="w-full h-40" style={{ opacity: 1, transform: 'none' }}>
        <div className="border-border/40 lg:flex lg:items-center lg:justify-between w-full pt-7">
