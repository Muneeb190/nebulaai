...
import { Spotlight } from "@/components/ui/mouseeffect";

export function GridPatternSpotlight() {
  return (
    <div className='relative aspect-video h-[200px] rounded border border-zinc-100 bg-black dark:border-zinc-800 dark:bg-black'>
      <Spotlight
